	...
	return (
		...
		>
			...
			>
				...
				<button
					type="button"
					className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#1457d2] px-6 py-3.5 text-[15px] font-semibold text-white transition hover:bg-[#0f3d9e]"
				>
